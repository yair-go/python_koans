...
class AboutSets(Koan):
    def test_sets_make_keep_lists_unique(self):
        ...
        self.assertEqual({'Malcolm', 'Ramirez', 'MacLeod', 'Matunas'}, there_can_only_be_only_one)
    ...
    def test_dictionaries_and_sets_use_same_curly_braces(self):
        ...
        self.assertEqual(set([]).__class__, {1, 2, 3}.__class__)
        self.assertEqual(dict().__class__, {'one': 1, 'two': 2}.__class__)

        self.assertEqual(dict().__class__, {}.__class__)
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual({'Willie', 'Leonidas', 'MacLeod', 'Wallace'}, scotsmen | warriors)
